...
<option value="m">Metres</option><option value="mm">Millimetres</option>
...
renderer.domElement.addEventListener("pointerdown",e=>{
  ...
  if(pts.size===2){pinch=spread(); drag=null;}
...
document.getElementById("units").onchange=e=>{units=e.target.value; selectPiece(selPiece);};
